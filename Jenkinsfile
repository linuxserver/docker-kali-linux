pipeline {
  ...
  environment {
    ...
    LS_USER = 'linuxserver'
    LS_REPO = 'docker-kali-linux'
    CONTAINER_NAME = 'kali-linux'
    DOCKERHUB_IMAGE = 'linuxserver/kali-linux'
    DEV_DOCKERHUB_IMAGE = 'lsiodev/kali-linux'
    PR_DOCKERHUB_IMAGE = 'lspipepr/kali-linux'
    DIST_IMAGE = 'ubuntu'
    MULTIARCH='true'
    CI='true'
    CI_WEB='true'
    ...
    stage('Build-Single') {
      ...
      steps {
        ...
        sh "docker buildx build \
          ...
          --label \"org.opencontainers.image.url=https://github.com/linuxserver/docker-kali-linux/packages\" \
          --label \"org.opencontainers.image.documentation=https://docs.linuxserver.io/images/docker-kali-linux\" \
          --label \"org.opencontainers.image.source=https://github.com/linuxserver/docker-kali-linux\" \
          ...
          --label \"org.opencontainers.image.description=[Kali-linux](https://github.com/linuxserver/docker-kali-linux) - is an Advanced Penetration Testing Linux distribution used for Penetration Testing, Ethical Hacking and network security assessments. KALI LINUX ™ is a trademark of OffSec.  \" \
